...
public final class ArrayMap<K, V> implements Map<K, V> {
    ...
    public android.util.ArrayMap<K, V> toAndroidDotUtilDotArrayMap() {
        android.util.ArrayMap<K, V> map = new android.util.ArrayMap(mSize);
        map.putAll(mCollections.colGetMap());
        return map;
    }
